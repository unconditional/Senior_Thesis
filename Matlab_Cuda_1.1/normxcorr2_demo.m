...
template2 = rand(templateSize); % template with random entries
...
img( embedY:embedY+templateSize-1, embedX:embedX+templateSize-1 ) = template2;
...
ncc = normxcorr2_mex(template2, img, 'same');
