...
* @note This function is designed to work with many frames. In addition, it references a provided MATLAB function which takes the video, the target matrix and the x and y arrays as arguments and returns the likelihoods
...
/**
* The implementation of the particle filter using some CUDA for a single image
* @see http://www.nvidia.com/object/cuda_home_new.html
